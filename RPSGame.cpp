...
void RPSGame::playGame()
{
	...
	while (gameRun)
	{
		...
		else
		{
			...
			cout << endl << "Round " << currentRound << " score:    You: " << humanWins << "  Computer: " << computerWins << endl << endl;
		...
		case 1: //Human tool Strength
		{
			...
			while (humanToolSettingsRun) {
				...
				case 1: // Set Human rock strength
				{
					...
					cin >> tempStrength;
					humanRockStrength = validateBetween(tempStrength, minStrength, maxStrength);
				...
				case 2: // Set Human paper strength
				{
					...
					cin >> tempStrength;
					humanPaperStrength = validateBetween(tempStrength, minStrength, maxStrength);
				...
				case 3: // Set Human scissor strength
				{
					...
					cin >> tempStrength;
					humanScissorStrength = validateBetween(tempStrength, minStrength, maxStrength);
					break;
				}
				case 4: {
		...
		case 2: //Computer tool Strength
		{
			...
			while (computerToolSettingsRun) {
				...
				case 1: // Set Computer rock strength
				{
					cout << endl << "Enter new rock strength: ";
					cin >> tempStrength;
					computerRockStrength = validateBetween(tempStrength, minStrength, maxStrength);
					break;
				}
				case 2: // Set Computer paper strength
				{
					cout << endl << "Enter new paper strength: ";
					cin >> tempStrength;
					computerPaperStrength = validateBetween(tempStrength, minStrength, maxStrength);
					break;
				}
				case 3: // Set Computer scissor strength
				{
					cout << endl << "Enter new scissor strength: ";
					cin >> tempStrength;
					computerScissorStrength = validateBetween(tempStrength, minStrength, maxStrength);
					break;
				}
				case 4: {
